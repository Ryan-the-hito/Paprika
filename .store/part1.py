...
from PyQt6.QtWidgets import (QWidget, QPushButton, QApplication,
                             ...
                             QSystemTrayIcon, QMenu, QComboBox, QDialog, QLCDNumber, QLineEdit)
from PyQt6.QtCore import Qt, QTimer, QRegularExpression
from PyQt6.QtGui import QAction, QIcon, QRegularExpressionValidator, QIntValidator
import PyQt6.QtGui
import datetime
...
class window_about(QWidget):  # 增加说明页面(About)
    ...
    def setUpMainWindow(self):
        widg1 = QWidget()
        l1 = QLabel(self)
        png = PyQt6.QtGui.QPixmap('paprika.png')  # 调用QtGui.QPixmap方法，打开一个图片，存放在变量png中
        ...
        widg3 = QWidget()
        lbl1 = QLabel('Version 0.0.6', self)
        blay3 = QHBoxLayout()
